...
> **已知遗留（挂起）**：macOS Sequoia（Darwin 24.6）下透明窗**四角偶现黑底**——属系统对透明窗的重绘 bug（tauri #8255 / #10306），`macos-private-api` feature 已确认编入、配置三件套齐全，`visible:true` 出生即可见与 show 后强制重绘均无法根治，暂作遗留问题。
