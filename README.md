...
**v1.1.2 — 已完成入口移顶栏 · 任务卡双击即编辑 · 日历年月滚轮**（承 v1.1.x 行内编辑 / 回到今天 / 当日小记），端到端闭环完整。以下按能力域概览，详细功能与版本演进见 `CHANGELOG.md` 和 `doc/milestones.md`。
...
- **全部任务**：主列表 + 顶栏右侧「已完成任务」入口（打开已完成浮窗）；完成满 7 天物理删除，支持一键清理所有已完成。
